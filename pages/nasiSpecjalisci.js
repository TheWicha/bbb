...
import { P, GoHome, SiteTitle, TittleH2, ContactUs, Okruszki, H3 } from "../styledComponents/WithStyles";
...
const nasiSpecjalisci = ({ lang }) => {
  ...
  return (
    <>
      <Head>
        <title>
          {lang ? "Nasi Specjaliści - Fundacja Biznes Bez Barier" : "Our experts - Business Without Barries"}
        </title>
        <meta property="og:title" content={"NASI SPECJALIŚCI"} key="title" />
        <meta
          property="og:image"
          content={"https://biznesbezbarier.org/_next/static/images/0-f56a85c0f5abcf6128a9aba1ff74648f.png"}
          key="image"
        />
        <meta
          property="og:description"
          content={
            "Wiemy, jak możemy pomóc pracodawcom w przeprowadzeniu rekrutacji osób podobnych nam. Dlatego – co jest niezwykle istotne – rekrutujemy tylko i wyłącznie SKUTECZNYCH i NAJLEPSZYCH"
          }
          key="description"
        />
        <meta property="og:url" content={`https://biznesbezbarier.org/nasiSpecjalisci`} key="url" />
      </Head>
        ...
        <div className="about-site-name">
          <div>
            <section className="about-actions">
              <h2 className="styled-h2">{lang ? "Współpracują z nami" : "Experts who work with us"}</h2>
            </section>
          </div>
        </div>
      </div>
      <section className="expContactWrapper">
        <div className="expContactContainer">
          <div className="expContactImg">
            <img src={img} alt="" />
          </div>
          <div className="firstP">
            <div className="expContactText" id="skip">
      ...
      <div className="expBoxWrapperReverse">
        <div className="expUpperLeftBox">
          <h3 className="styled-h3">EWA LEFIK-BABIASZ</h3>
          <p className="styled-p">
            {lang
      ...
      <section className="expContactWrapper">
        <div className="expBoxWrapper">
          <div className="expImgWrapper">
            <img src={img5} alt="" />
          </div>
          <div className="expUpperLeftBox">
            <h3 className="styled-h3">MARCIN FRANKE</h3>
            <p className="styled-p">
              {lang
      ...
      <div className="expBoxWrapperReverse">
        <div className="expUpperLeftBox">
          <h3 className="styled-h3">SEBASTIAN KAWECKI</h3>
          <p className="styled-p">
            {lang
      ...
      <section className="expContactWrapper">
        <div className="expBoxWrapper">
          ...
          <div className="expUpperLeftBox">
            <h3 className="styled-h3">GABRIEL OSIEWAŁA</h3>
            <p className="styled-p">
              {lang
      ...
      <ContactUs lang={lang} />
      <div className="expFundationContainer">
        <GoHome lang={lang} />
      </div>
    </>
  );
...
export default nasiSpecjalisci;
