...
const Declaration = ({ lang }) => {
  return (
    <>
      ...
      <TittleH2
        title={lang ? "Dostępność strony biznesbezbarier.org" : "Accesibility of the biznesbezbarier.org website"}
      />
      <FundationWrapper>
        <FundationContainer>
          <P>
...
`
          ...
          <H3>{lang ? `INFORMACJE ZWROTNE I DANE KONTAKTOWE` : `FEEDBACK AND CONTACT INFORMATION`}</H3>
 ...
 zapewnienia dostępności. `
      ...
      <TittleH2 title={lang ? "Dostępność architektoniczna" : "Architectural accessibility"} />
      <FundationWrapper>
        <FundationContainer>
          <P>
          ...
          <H3>{lang ? `DOJAZD I WEJŚCIE DO BUDYNKU` : `ACCESS AND ENTRY TO THE BUILDING`}</H3>
          <List>
            <ul>
              <li>
                {lang
          ...
          <H3>{lang ? `ARCHITEKTURA BUDYNKU` : `ARCHITECTURE OF THE BUILDING`}</H3>
          <List>
            <ul>
              <li>
                {lang
          ...
          <H3>{lang ? `PORUSZANIE SIĘ PO BUDYNKU` : `MOVING AROUND THE BUILDING`}</H3>
          <List>
            <ul>
              <li>
                {lang
