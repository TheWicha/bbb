  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:title"
          content={"ADRIAN FURMAN – FUNDATOR I CZŁONEK RADY FUNDACJI BIZNES BEZ BARIER"}
          key="title"
        />
        <meta
          property="og:image"
          content={"https://biznesbezbarier.org/_next/static/images/1-1016e80c25db5ec0fcf86068ed6c400b.png"}
          key="image"
        />
        <meta
          property="og:description"
          content={
            "Adrian Furman, członek Rady Dostępności, prezes Grupy AF sp. z o.o. - największej w Polsce firmy zatrudniającej specjalistów z niepełnosprawnością, właściciel spółki w USA – Poland IT-Lab LLC."
          }
          key="description"
        />
        <meta property="og:url" content={`https://biznesbezbarier.org/fundator`} key="url" />
      </Head>
      ...
      <section className="founderSectionWrapper">
        <div className="founderContainer">
          <div className="founderText" id="skip">
            ...
            <h2 className="styled-h2a">{lang ? `NAJWAŻNIEJSZE ODZNACZENIA` : `NOTABLE DISTINCTIONS`}</h2>
            <p className="styled-p">
              {lang
      ...
      <section className="founderSectionWrapper">
        <div className="moreInfoContainer">
          <div className="moreInfoText">
            <h2 className="styled-h2a">
              {lang ? `MIĘDZYNARODOWE KONFERENCJE BIZNESOWE` : `INTERNATIONAL BUSINESS CONFERENCES`}
            </h2>
            <p className="styled-p">
              {lang
            ...
            <p className="styled-p">
              ...
              <br />{" "}
              <a className="outLink" target="__blank" href="https://www.adrianfurman.com/">
